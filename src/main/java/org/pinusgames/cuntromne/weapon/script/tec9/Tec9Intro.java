...
public class Tec9Intro extends Script {
    ...
    public boolean step() {
        ...
        if( this.frame == -1 ) {
            this.animation = Animations.animations.get("tec9.intro");
        ...
        if(this.frame == 10 && this.next) {
            this.data.player.getWorld().playSound(this.data.player.getLocation(), "ctum:tec9.intro", 1, 1);
        }
