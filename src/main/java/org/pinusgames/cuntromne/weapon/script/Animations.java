...
public class Animations {
    ...
    public static void initAnimates() {
        ...
        animations.put("p250.fire", new int[]{
                1101, 1102, 1103, 1100
        });
        animations.put("p250.reload", new int[]{
                1110, 1111, 1112, 1113, 1114, 1115, 1116, 1117, 1118, 1119,
                1120, 1121, 1122, 1123, 1124, 1125, 1126, 1127, 1128, 1129,
                1130, 1131, 1132, 1133, 1134, 1135, 1100
        });
        animations.put("p250.intro", new int[]{
                1150, 1151, 1152, 1153, 1154, 1155, 1156, 1157, 1158, 1159, 1160, 1161, 1162
        });
        animations.put("tec9.fire", new int[]{
                1201, 1202, 1203, 1204, 1200
        });
        animations.put("tec9.reload", new int[]{
                1210, 1211, 1212, 1213, 1214, 1215, 1216, 1217, 1218, 1219,
                1220, 1221, 1222, 1223, 1224, 1225, 1226, 1227, 1228, 1229,
                1230, 1231, 1232, 1233, 1234, 1235, 1236, 1237, 1238, 1239,
                1240, 1200
        });
        animations.put("tec9.intro", new int[]{
                1250, 1251, 1252, 1253, 1254, 1255, 1256, 1257, 1258,
                1260, 1261, 1262, 1263, 1264, 1265, 1266, 1267, 1268, 1200
        });
    }
}
